...
/**
 * Parse-spec class for the use of apis
 * @author neil.zxy
 * @date 2024-07-23 17:44
 */
...
import { each, filter, find, has, includes, isArray, isEmpty, isString, keys, map, set, split } from 'lodash';
...
export class ParseSpecForContent {
  ...
  constructor(yamlContent: string = '', private options: IOptions = {}) {
